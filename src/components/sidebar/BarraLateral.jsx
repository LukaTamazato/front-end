            ...
            >
                ...
                >
                    ...
                    { tipoUsuario === 'colaborador' && (    
                        <>
                        <Item sx={{mt: 2}} smallText={false} onClick={() => handleActivateItem('i0')} active={activeItem === 'i0'} icon={<HomeIcon />} linkTo="/" text="Home" />
                        <Item onClick={() => handleActivateItem('i2')} active={activeItem === 'i2'} theme={theme.palette.primary.lighter} linkTo="/eventos-confirmados" icon={<CheckBoxOutlinedIcon />} text="Eventos confirmados" />
                        <Item onClick={() => handleActivateItem('i3')} active={activeItem === 'i3'} theme={theme.palette.primary.lighter} linkTo="/eventos-pendentes" icon={<AccessTimeIcon />} text="Eventos pendentes" />
                        <Item onClick={() => handleActivateItem('i4')} active={activeItem === 'i4'} theme={theme.palette.primary.lighter} linkTo="/eventos/buscar" icon={<SearchIcon />} text="Buscar" />
                        <Item onClick={() => handleActivateItem('i5')} active={activeItem === 'i5'} theme={theme.palette.primary.lighter} linkTo="/convites" icon={<MailIcon />} text="Convites" />
                        </>
                    )}
                </Menu>
            </Sidebar>
