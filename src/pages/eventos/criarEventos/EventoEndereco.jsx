...
const EventoEndereco = ({handleEnderecoChange, handleUfChange, dadosEvento, handleViaCEPResponse}) => {
    ...
    return (
        <>
            ...
            <Grid width="80%" margin="auto" container columnSpacing={2}>
                <CampoTexto size={12} handleChange={handleEnderecoChange} value={dadosEvento.endereco.logradouro} name="logradouro" label="Logradouro"/>
                <CampoTexto handleChange={handleViaCEP} value={dadosEvento.endereco.cep} name="cep" mascara="cep" regex={/^\d{5}-\d{3}$/} label="CEP"/>
                <CampoTexto handleChange={handleEnderecoChange} value={dadosEvento.endereco.numero} mascara="numeroPositivo" name="numero" label="Número"/>
                <CampoTexto handleChange={handleEnderecoChange} value={dadosEvento.endereco.cidade} name="cidade" label="Cidade"/>
                <Grid2 size={6} mt={2}>
                    <Autocomplete
                        disablePortal
                        options={estados}
                        getOptionLabel={(option) => option.value}
                        value={estados.find((estado) => estado.id === dadosEvento.endereco.uf) || null}
